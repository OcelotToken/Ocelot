...
contract OCELOT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1890f80669c4902c3b68066B448871b2e0bdBd9e); // Marketing Address
    ...
    string private _name = "OCELOT";
    string private _symbol = "OCELOT";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x1890f80669c4902c3b68066B448871b2e0bdBd9e);
    }
